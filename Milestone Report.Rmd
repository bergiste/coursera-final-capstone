...
file.copy(flist, "presentation_data")
...
### Common Words
Words were independently analyzed in each of the corpus files (at a higher sample rate of 40%). Subsequently all files were combined and analyzed (at a lower sample rate of 10%). The most frequent words varied per corpus, however, the words "will", "just", and "can" made the top 10 in all 3 documents. The barplots and word clouds graphics below shows the details.
